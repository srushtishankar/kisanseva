...
# List of directories to look for (including kisanseva)
directories=("apps" "templates" "static" "management" "migrations" "tests" "kisanseva")

# List of file types to ignore (added static asset patterns and bytecode)
ignore_files=("*.ico" "*.png" "*.jpg" "*.jpeg" "*.gif" "*.svg" "*.pyc" "*.db" "*.log")
